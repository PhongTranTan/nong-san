            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <table id="datatable" class="table table-bordered table-striped table-hover dataTable"
                        ...
                        <thead>
                        <tr>
                            <th width="40">{!! trans("admin_district.table.id") !!}</th>
                            <th>{!! trans("admin_district.table.name") !!}</th>
                            <th>{!! trans("admin_district.table.active") !!}</th>
                            <th width="150">{!! trans("admin_district.table.action") !!}</th>
                        </tr>
                        </thead>
                    </table>
                </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/district.index.js?v=1"></script>
@endsection