            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <table id="datatable" class="table table-bordered table-striped table-hover dataTable"
                        ...
                        <thead>
                        <tr>
                            <th width="40">{!! trans("admin_guides.table.id") !!}</th>
                            <th>{!! trans("admin_guides.table.name") !!}</th>
                            <th>{!! trans("admin_guides.table.highlight") !!}</th>
                            <th>{!! trans("admin_guides.table.active") !!}</th>
                            <th width="150">{!! trans("admin_guides.table.action") !!}</th>
                        </tr>
                        </thead>
                    </table>
                </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/guides.index.js?v=1"></script>
@endsection