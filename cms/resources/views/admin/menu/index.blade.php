        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable" style="width: 100%">
                    <thead>
                    <tr>
                        <th width="40">{!! trans("admin_menus.table.id") !!}</th>
                        <th>{!! trans("admin_menus.table.title") !!}</th>
                        <th>{!! trans("admin_menus.table.type") !!}</th>
                        <th width="150">{!! trans("admin_menus.table.action") !!}</th>
                    </tr>
                    </thead>
                </table>
            </div>
