...
@section("meta")
    <meta name="linkDatatable" content="{{ route('admin.customer.datatable') }}"/>
@endsection
        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable" style="width: 100%">
                    <thead>
                    <tr>
                        <th width="40">{!! trans("admin_customer.table.id") !!}</th>
                        <th>{!! trans("admin_customer.table.name") !!}</th>
                        <th>{!! trans("admin_customer.table.email") !!}</th>
                        <th>{!! trans("admin_customer.table.active") !!}</th>
                        <th>{!! trans("admin_customer.table.created_at") !!}</th>
                        <th width="150">{!! trans("admin_customer.table.action") !!}</th>
                    </tr>
                    </thead>
                </table>
            </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/customer.index.js?v=1.2"></script>
@endsection