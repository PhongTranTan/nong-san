        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                @component('admin.layouts.components.form', [
                    ...
                    'form_url' => empty($type) ? route("admin.floortype.store") : route("admin.floortype.update", $type->id)
                ])
                    <!-- Nav tabs -->
                        @include('admin.translation.nav_tab', [
                            'default_tabs' => [
                                [
                                    ...
                                    'path' => 'admin.floortype.partials.general'
                                ]
                            ],
                        ...
                        @include("admin.layouts.partials.form_buttons", [
                            "cancel" => route("admin.floortype.index")
                        ])
                    @endcomponent
                </div>
            </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/floortype.create.js?v=1"></script>
@endsection
