...
@section("content")
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <a href="{!! route("admin.budgets.create") !!}" class="btn btn-info waves-effect pull-right">
                        <i class="material-icons">add</i>
                        <span>{!! trans("button.create") !!}</span>
                    </a>
                    <h2>
                        {!! trans("admin_budgets.list") !!}
                    </h2>
                ...
                <div class="body">
                    ...
                    <table id="datatable" class="table table-bordered table-striped table-hover dataTable"
                        ...
                        <thead>
                        <tr>
                            <th width="40">{!! trans("admin_budgets.table.id") !!}</th>
                            <th>{!! trans("admin_budgets.table.name") !!}</th>
                            <th width="150">{!! trans("admin_budgets.table.action") !!}</th>
                        </tr>
                        </thead>
                    </table>
                </div>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/budgets.index.js?v=1"></script>
@endsection