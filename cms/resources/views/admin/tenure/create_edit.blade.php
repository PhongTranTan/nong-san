        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                @component('admin.layouts.components.form', [
                    'form_method' =>  empty($tenure) ? 'POST' : 'PUT',
                    'form_url' => empty($tenure) ? route("admin.tenure.store") : route("admin.tenure.update", $tenure->id)
                ])
                    <!-- Nav tabs -->
                        @include('admin.translation.nav_tab', [
                            'default_tabs' => [
                                [
                                    ...
                                    'path' => 'admin.tenure.partials.general'
                                ]
                            ],
                            'object_trans' => $tenure ?? null,
                            'default_tab' => 'general',
                            'form_fields' => [
                                ['type' => 'text', 'name' => 'name'],
                            ],
                        ...
                        @include("admin.layouts.partials.form_buttons", [
                            "cancel" => route("admin.tenure.index")
                        ])
                    @endcomponent
                </div>
            </div>
