                ...
                <div class="body">
                    ...
                    <table id="datatable" class="table table-bordered table-striped table-hover dataTable"
                        ...
                        <tr>
                            ...
                            <th>{!! trans("admin_product.table.position") !!}</th>
                            <th>{!! trans("admin_product.table.active") !!}</th>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/product.index.js?v=1"></script>
@endsection