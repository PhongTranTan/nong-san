            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <table id="datatable" class="table table-bordered table-striped table-hover dataTable"
                        ...
                        <thead>
                        <tr>
                            <th width="40">{!! trans("admin_review.table.id") !!}</th>
                            <th>{!! trans("admin_review.table.name") !!}</th>
                            <th>{!! trans("admin_review.table.position") !!}</th>
                            <th>{!! trans("admin_review.table.active") !!}</th>
                            <th width="150">{!! trans("admin_review.table.action") !!}</th>
                        </tr>
                        </thead>
                    </table>
                </div>
