<style>
    /* code chống chế cho Minh Phạm */
    .pdetail-content .section-full.no-full {
...
<section class="section-full pdetail-s-gallery pdetail-spacing" data-anchor="gallery">
    ...
    <div class="owl-carousel">
        ...
        @php $i = 1; $count = (count($project_galleries) - 1) / 6; @endphp
            @for($j = 0; $j <= $count; $j++)
                @php $l = 1; @endphp
                    ...
                    <div class="grid-gallery">
                        ...
                        @for($k = $j * 6; $k <= $j * 6 + 5; $k++)
                            @if($i <= count($project_galleries))
                                ...
                                <div class="grid-item 
                                    @if($i == 3) size-vertical @endif 
                                    @if($i == 4 || $i == 6) small @endif 
                                    @if($i == 5) size-horizontal @endif"
                                >
                                    <div class="item-img">
