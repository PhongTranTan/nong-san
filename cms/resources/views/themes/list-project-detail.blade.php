                    ...
                    <div class="col-lg-4 col-md-12 content-left">   
                        ...
                        <div class="grid-control">
                            <div class="filter-form form-sort">
                                ...
                                <div class="view-control-group"><a class="btn-grid" href="{{ getPageUrlByCode('ALL-PROJECTS') }}">Grid </a><a class="btn-detail active" href="{{ getPageUrlByCode('ALL-PROJECTS-DETAILED') }}"> Detailed</a></div>
                            </div>
                        </div>
                        <!--List project-->
                                    ...
                                    <div class="col-xl-6 item-detail @if($i == 0 ) active @endif">
                                        <div class="nl-grid-item current-item">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="desc">{{ (isset($project->description) && $project->description != null) ? $project->description : "..." }}</div>
                                                <div class="logo">
                        ...
                        {{-- @php dd($projects, $count_projects) @endphp --}}
                        @if($count_projects > 1)
