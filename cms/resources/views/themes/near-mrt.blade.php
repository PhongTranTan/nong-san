                    ...
                    <div class="container">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Near MRT</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <form method="get" id="form-sort">
                            ...
                            <div class="tenue">
                                <div class="nl-dropbox">
                                    ...
                                    <div class="view-control-group"><a class="btn-grid active" href="{{ getPageUrlByCode('NEAR-MRT') }}">Grid </a><a class="btn-detail" href="{{ getPageUrlByCode('NEAR-MRT-DETAILED') }}"> Detailed</a></div>
                </div>
            </div>
