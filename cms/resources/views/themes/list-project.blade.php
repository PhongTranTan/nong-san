                    ...
                    <div class="container">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All New Launches</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="filter-form form-sort">
                    {{-- <div class="sort-group">
                        ...
                        <form method="get" id="form-sort">
                            <div class="tenue">
                                <select class="select-ui" data-placeholder="Name" name="sort" tabindex="1" id="sort-name">
                    ...
                    <div class="view-control-group"><a class="btn-grid active" href="{{ getPageUrlByCode('ALL-PROJECTS') }}">Grid </a><a class="btn-detail" href="{{ getPageUrlByCode('ALL-PROJECTS-DETAILED') }}"> Detailed</a></div>
                </div>
            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                           ...
                           {{--  <script>
                                jQuery(window).on('load', function(){
                                    open_socials('{{ $project->id }}', '{{ $project->facebook }}', '{{ $project->twitter }}', '{{ $project->linkedin }}');
                                });
                            </script> --}}
                        </div>
...
<script src="{{ url('assets/js/pages.js') }}"></script>
<script>
