                    ...
                    <div class="grid-control">
                        <div class="filter-form form-sort">
                            <div class="sort-group">
                             ...
                             <div class="view-control-group"><a class="btn-grid" href="{{ getPageUrlByCode('FREEHOLD') }}">Grid </a><a class="btn-detail active" href="{{ getPageUrlByCode('FREEHOLD-DETAILED') }}"> Detailed</a></div>
                        </div>
                    </div>
                    <!--List project-->
...
<script>
    ...
    $("#btn-load-more").click(function(){
        ...
        $.ajax({
            type:'POST',
            url: '{{ route('project.freehold.load.more') }}',
            data: {
                take: take
            },
            dataType: 'json',
