                ...
                <div class="col-lg-4 col-md-12 content-left">   
                    ...
                    <div class="grid-control">
                        <div class="filter-form form-sort">
                            ...
                            <div class="view-control-group"><a class="btn-grid" href="{{ getPageUrlByCode('HEAVILY') }}">Grid </a><a class="btn-detail active" href="{{ getPageUrlByCode('HEAVILY-DETAILED') }}"> Detailed</a></div>
                        </div>
                    </div>
                    <!--List project-->
...
<script>
    ...
    $("#btn-load-more").click(function(){
        ...
        $.ajax({
            type:'POST',
            url: '{{ route('project.heavily.load.more') }}',
            data: {
                take: take
            },
            dataType: 'json',
