                ...
                <div class="col-lg-4 col-md-12 content-left">   
                    ...
                    <div class="grid-control">
                        <div class="filter-form form-sort">
                            ...
                            <div class="view-control-group"><a class="btn-grid" href="{{ getPageUrlByCode('BELOW-7000') }}">Grid </a><a class="btn-detail active" href="{{ getPageUrlByCode('BELOW-7000-DETAILED') }}"> Detailed</a></div>
                        </div>
                    </div>
                    <!--List project-->
...
<script>
    ...
    $("#btn-load-more").click(function(){
        ...
        $.ajax({
            type:'POST',
            url: '{{ route('project.below.load.more') }}',
            data: {
                take: take
            },
            dataType: 'json',
