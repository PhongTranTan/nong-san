            ...
            <div class="container nl-container grid-control">
                ...
                <div class="filter-form form-sort">
                    <div class="sort-group">
                     ...
                     <div class="view-control-group"><a class="btn-grid active" href="{{ getPageUrlByCode('INVESTOR') }}">Grid </a><a class="btn-detail" href="{{ getPageUrlByCode('INVESTOR-DETAILED') }}"> Detailed</a></div>
                </div>
            </div>
