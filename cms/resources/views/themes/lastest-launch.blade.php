                    ...
                    <div class="container">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Lastest Launches</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <form method="get" id="form-sort">
                            ...
                            <div class="tenue">
                                <div class="nl-dropbox">
                                    ...
                                    <div class="view-control-group"><a class="btn-grid active" href="{{ getPageUrlByCode('LASTEST-LAUNCHES') }}">Grid </a><a class="btn-detail" href="{{ getPageUrlByCode('LASTEST-LAUNCH-DETAILED') }}"> Detailed</a></div>
                </div>
            </div>
