            ...
            <div class="row content-detail"> 
                ...
                <div class="col-lg-4 col-md-12 content-left">   
                    ...
                    <div class="grid-control">
                        <div class="filter-form form-sort">
                            ...
                            <div class="view-control-group"><a class="btn-grid" href="{{ getPageUrlByCode('SEARCH-INDEX') }}?{{ http_build_query(empty2blank($parameters)) }}">Grid </a><a class="btn-detail active" href="{{ getPageUrlByCode('SEARCH-INDEX-DETAIL') }}?{{ http_build_query(empty2blank($parameters)) }}"> Detailed</a></div>
                        </div>
                    </div>
                    <!--List project-->
                ...
                <div class="content-grid-detail col-lg-8 col-md-12" style="background-image: url({{ $projects[0]->project_background_section }})">
                    ...
                    <div class="content-right">
                        ...
                        </div><a class="btn-nlp blue" href="{{ route('frontend.project.detail', ['slug' => $projects[0]->slug]) }}">Enter Project Page </a>
                    </div>
                </div>
                <div class="group-btn">
                    <button class="btn-favorite" type="button" data-project="{{ $projects[0]->id }}"> 
                        <div class="l1">Favourite</div>
                        <div class="l2">Favourited</div>
                    </button>
                </div>
                @endif
                @else
            ...
            success:function(reponse){
                ...
                if(reponse.length > 0){
                    reponse.forEach(function(project){
                        ...
                        list += '<div class="group-share"></div>';
                        list += '</div>';
                        list += '</div>';
                        list += '</div>';
                        list += '</div>';
